...
class UploadTaskMetadata {
  ...
  /// Bumped for each queued chunk so task ids stay unique when a 409 sends the chain back to
  /// an offset it has already used.
  final int attempt;
  ...
  bool operator ==(covariant UploadTaskMetadata other) {
    ...
    return other.localAssetId == localAssetId &&
        ...
        other.uploadOffset == uploadOffset &&
  ...
  int get hashCode =>
      ...
      uploadUrl.hashCode ^
      uploadOffset.hashCode ^
      uploadTotal.hashCode ^
      attempt.hashCode;
}
